...
patients = [DOIfolderpath + meta['Patient Id'][i] for i in range(1)]
datfolder = []
...
enhanced_nodule_image = exposure.equalize_hist(noduleimages)
np.save(datafolder + '/enhanced_nodule_image.npy', enhanced_nodule_image)
print(calculate_psnr(enhanced_nodule_image,noduleimages))
...
#Median_filtered= skimage.filters.median(noduleimages[0],selem=np.ones((12,12)))
#plt.figure()
#plt.imshow(Median_filtered,cmap="gray", interpolation="bicubic")
#plt.show()
#plt.hist(a1_eq.flatten(),bins='auto')
#plt.hist(a1_eq, bins='auto')
...
#np.save(datafolder + "MedianFilterimages.npy", Median_filtered)
#file_used = datafolder + "MedianFilterimages.npy" 
...
#plt.figure()
#plt.imshow(noduleimages[0],cmap="gray", interpolation="bicubic")
#plt.show()

#filename = get_testdata_files(filtered_image)
#print(filtered_image)


#fig1  = plt.figure()
#plt.imshow(noduleimages, cmap="gray", interpolation="bicubic")
...
#hist_eq,bins_eq = np.histogram(a1_eq, bins=256)
#
#np.save(datafolder + "/processed_images.npy" , a1_eq)
#np1 = np.load(datafolder + "/processed_images.npy")
#
#plt.figure()
#plt.imshow(np1[0],cmap="gray", interpolation="bicubic")
#plt.show()
#fig2 = plt.figure()
#plt.imshow(np1, cmap="gray", interpolation="bicubic")
#fig2.suptitle("Histogram equalization ", fontsize=12)

#file_used = datafolder + "processed_images.npy"
#imgs_to_process = np.load(file_used)
#fig1  = plt.figure()
#plt.imshow(noduleimages, cmap="gray", interpolation="bicubic")
